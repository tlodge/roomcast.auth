...
var Menu = React.createClass({displayName: "Menu",
  ...
  componentDidMount: function() {
	...
	//added by tlodge 16 March 2015 to adapt to dynamic items
	this._singleMenuHeight = Math.floor(el.offsetHeight / this.props.menuItems.length)
  ...
  _renderVisibility: function() {
    ...
    if (this.props.hideable) {
      ...
      if (this.props.visible) {
        ...
        //following line modified by tlodge 16 Mar 2015 to adapt to dynamic items.
        //el.style.height = this._initialMenuHeight + 'px';
		el.style.height = (this._singleMenuHeight * this.props.menuItems.length) + KeyLine.Desktop.GUTTER_LESS + 'px';
